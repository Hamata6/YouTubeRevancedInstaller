...
Invoke-Expression "java -jar revanced-cli-all.jar patch --patch-bundle revanced-patches.jar --out YouTubeMod.apk $devicecmd --merge app-release-unsigned.apk YouTube.apk"
